            ...
            <Container>
                ...
                <Row className={'justify-content-center my-4'}>
                    <Col sm={4} className={'text-center'}>
                        <Button className={'bg-main'} size="lg" onClick={ () => Next() }>Book a Time slot</Button>
                    </Col>
                </Row>
...
export function BackArrow(props) {
    return (
        <div className={'mt-2'}>
            <IoChevronBackCircleSharp size={40} className={'back-arrow'}/>
            {/*<Button variant={'light'} className={'rounded-circle back-arrow'} onClick={ () => props.Back() }>*/}
